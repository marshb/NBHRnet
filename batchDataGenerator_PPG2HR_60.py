...
class BatchPPGGenerator(Sequence):
    ...
    def __data_generation(self, list_files_temp):
        ...
        for i, filename in enumerate(list_files_temp):
            ...
            # PPG_filter = self.PPG_normalization(PPG_filter)
            # PPG[i, ] = gaussian_filter1d(data["PPG"], 2)
            PPG[i, ] = self.PPG_normalization_V2(data["PPG"][::2])
...
if __name__ == '__main__':
    ...
    for i in range(200):
        PPG, HR = data_generator.__getitem__(i)
